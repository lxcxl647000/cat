...
interface _requestGamePaymentany {
  /**
   * 支付类型
   */
  mode: string;
...
interface _openAwemeCustomerService {
  /**
   * 币种：目前仅为 "CNY"
   */
  currencyType: string;
...
declare namespace tt {
  ...
  export function createContactButton(any: any): any;
  ...
  export function checkShortcut(any: any): any;
  export function addShortcut(any: any): any;
   ...
   * 发起Android支付。
   */
  export function requestGamePayment(any: _requestGamePaymentany): void;

  /**
   * 发起ios支付。(仅支持抖音，建议限制在抖音ios版本大于等于22.5.0时用户可使用)
   * @param any 
   */
  export function openAwemeCustomerService(any: _openAwemeCustomerService): void;
