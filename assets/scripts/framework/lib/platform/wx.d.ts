...
declare namespace wx {
  ...
  export function getRealtimeLogManager(): any;
  export function createGameClubButton(any: any): any;
  export function requestSubscribeMessage(any: any): any;
  export function requestSubscribeSystemMessage(any: any): any;
  export function createFeedbackButton(any: any): any;
  ...
  /**内存警告 */
  export function onMemoryWarning(any: Function): void;
   ...
   */
  export function connectSocket(any: _connectSocketany): any;
  ...
  export function createGameIcon(a: any): any;
  /**换量插屏  浮层广告*/
  export function createGamePortal(a: any): any;
  export function createCustomAd(a: any): any;
  export function createGridAd(a: any): any;
  /**
   ...
   * 获取网络类型。
   */
  export function getNetworkType(any: any): void;
   ...
   * 发起微信支付。
   */
  export function requestMidasPayment(any: _requestPaymentany): void;
   ...
   */
  export function setStorage(any: any): void;
   ...
   */
  export function setTabBarBadge(any: _setTabBarBadgeany): void;
   ...
   * 显示消息提示框
   */
  export function showToast(any: any): void;
  ...
  /**  */
  export function operateGameRecorderVideo(a: any): void;

  /** 获取游戏圈数据，从 2.25.4 基础库开始支持 */
  export function getGameClubData(a: any): any;

  /** 打开游戏内容页面，从 2.25.1 基础库开始支持 */
  export function openPage(a: any): any;

  //选择图片
  export function chooseMedia(op: any);

  //压缩图片
  export function compressImage(op: any);
